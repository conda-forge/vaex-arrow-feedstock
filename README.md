About vaex-arrow-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/vaex-arrow-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3617&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/vaex-arrow-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `vaex-arrow` can be installed with `conda`:
...
```
mamba install vaex-arrow
```

It is possible to list all of the versions of `vaex-arrow` available on your platform with `conda`:
...
```
mamba search vaex-arrow --channel conda-forge
```
...
mamba repoquery search vaex-arrow --channel conda-forge

# List packages depending on `vaex-arrow`:
mamba repoquery whoneeds vaex-arrow --channel conda-forge

# List dependencies of `vaex-arrow`:
mamba repoquery depends vaex-arrow --channel conda-forge
```
